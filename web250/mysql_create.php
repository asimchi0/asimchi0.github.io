...
$query = " CREATE TABLE IF NOT EXISTS `" . $inventoryTable . "`
...
$query = "INSERT INTO `" . $inventoryTable . "`
...
if ($mysqli->query($query) === TRUE) {
    echo "<p>Honda Pilot inserted into table. </p>";
}
else
{
...
$query = "INSERT INTO `" . $inventoryTable . "` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
('LAKSDFJ234LASKRF2', '2009', 'Dodge', 'Durango', 'SLT', 'Silver', 'Black', '2700', NULL, '2000', '144000', '4WD Automatic', '2012-12-05', NULL);";


if ($mysqli->query($query) === TRUE) {
    echo "<p>Dodge Durango inserted into table.</p>";
}
else
{
...
$query3 = "INSERT INTO `" . $inventoryTable . "` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`)
 VALUES
...
if ($mysqli->query($query3) === TRUE) {
    echo "<p>27 cars inserted into table.</p>";
}
else
{
	echo $mysqli->error;
